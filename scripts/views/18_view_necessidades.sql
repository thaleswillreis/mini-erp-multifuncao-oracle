...
--TABELAS: ORDEM_PROD, FICHA_TECNICA, ESTOQUE,MATERIAL.

CREATE OR REPLACE VIEW VW_NECESSIDADES AS
    SELECT
        A.COD_EMPRESA,
        A.ID_ORDEM,
        A.COD_MAT_PROD,
        ...
        CASE 
            WHEN (A.QTD_PLAN-A.QTD_PROD)*B.QTD_NECES>NVL(C.QTD_SALDO,0)
                THEN 'FALTA ESTOQUE' 
            ELSE 'OK' 
        END MSG
    FROM 
