--=================================
-- PROCEDURE PROC_GER_PED_COMPRAS
--=================================

--PROCEDURE PARA CRIAR PEDIDOS DE COMPRAS A PARTIR DAS ORDENS DE PRODUCAO

--PARAMETROS 'P_EMP', 'P_MES' E 'P_ANO'
...
--TABELAS ATUALIZADA 'ORDEM_PROD' SITUACAO DE (A) 'ABERTA' PARA (P) 'PLANEJADA'
--DROP PROCEDURE PROC_GER_PED_COMPRAS
--EXEC PROC_GER_PED_COMPRAS 05,2017


--PRE REQUISITOS:
--CARGA DE DADOS NAS TABELAS 'MAT_FORNEC', 'FORNECEDORES' E 'MATERIAL'.
...
-- TENTATIVA DE ADIÇÃO DE MATERIAL INEXISTENTE PARA ESSE CÓDIGO DE EMPRESA
INSERT INTO MAT_FORNEC VALUES (1,17,2);
DELETE FROM MAT_FORNEC WHERE COD_MAT='17';

/*
CORREÇÃO DA TABELA 'MAT_FORNEC' COM A ADIÇÃO DE CHAVE ESTRANGEIRA PARA
RELACIONAR AS TABELAS 'COD_EMPRESA' E 'COD_MAT'
*/
ALTER TABLE MAT_FORNEC ADD FOREIGN KEY (COD_EMPRESA,COD_MAT) REFERENCES MATERIAL(COD_EMPRESA,COD_MAT);

/*
CORREÇÃO DA TABELA 'PED_COMPRAS_ITEN' COM A ALTERAÇÃO DO TIPO DE DADOS DO
ATRIBUTO 'QTD' PARA 'DECIMAL' DEVIDO AO USO DE MATERIAIS FRACIONADOS NOS PEDIDOS
*/
ALTER TABLE PED_COMPRAS_ITENS MODIFY QTD DECIMAL(10,2);

--FIM DA CARGA DE DADOS DE TESTE E CORREÇÕES
...
BEGIN 
    ...
    --VERIFICACAO: SE MES FOR JANEIRO ATRUBUIR MES=12 E ANO-1
    IF (P_MES='01')
        THEN
            P_MES_AUX:=12;
            P_ANO_AUX:=P_ANO-1;
    ...
    --VERIFICANDO SE EXISTEM ORDEM DE PRODUÇÃO
    ...
    /*
    CURSOR IMPLICITO PARA GRAVAR CABECALHO PEDIDO DE COMPRAS
    ...
    */
    FOR C_FORNEC IN (SELECT distinct A.COD_EMPRESA,D.ID_FOR,E.COD_PAGTO,
        ...
        --INSERT NA TABELA DE PEDIDOS DE COMPRAS
    ...
    /*
    CURSOR IMPLICITO PARA AUXILIAR NA GRAVAÇÃO DOS DETALHES DO PEDIDO DE COMPRAS
    NA TABELA 'PED_COMPRAS_ITENS'
    */
    FOR PED_IT IN (SELECT A.COD_EMPRESA,B.COD_MAT_NECES COD_MAT,D.ID_FOR,
        ...
        IF (V_NUM_PEDIDO<>NUM_PEDIDO_AUX) 
            THEN
                CONT_SEQ:=1;
                V_TOTAL_PED:=0;  
        END IF;
          
        --INSERINDO REGISTROS NA TABELA 'PED_COMPRAS_ITENS'
        ...
        --ATUALIZANDO TOTAL PEDIDO DA TABELA 'PED_COMPRAS'
...
--PARAMENTROS: EMPRESA, MES, ANO

SET SERVEROUTPUT ON
EXECUTE PROC_GER_PED_COMPRAS (1,'02','2026');
